    ...
    <nav id="navbar-main"
        ...
        <div class="container">
                                ...
                                <div class="col-12">
                                    ...
                                    <ul class="list-style-none mb-4">
                                        <li class="mb-2 megamenu-item">
                                            <a class="megamenu-link" href="{{route('admin.users.index')}}">Usuarios</a>
                                        </li>

                                        <li class="mb-2 megamenu-item">
                                            <a class="megamenu-link" href="">configuración</a>
                                        </li>
                                        <li class="mb-2 megamenu-item">
                                            <a class="megamenu-link" href="/logout">Cerrar sesion</a>
                                        </li>
                                    </ul>
            ...
            <div class="d-none d-lg-block @@cta_button_classes">
                <a href="/dashboard/admin/documentos"  class="btn btn-md btn-outline-white animate-up-2 mr-3"><i
                        class="fas fa-book mr-1"></i> <span class="d-xl-none">Documentos</span> <span
                        class="d-none d-xl-inline">Documentos</span></a>
                <a href="/dashboard/admin/documentos/create"
